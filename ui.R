    ...
    sidebarLayout(
        ...
        '),
           ...
           Describe what I'm measuring and relate the 'best' to output. 
            ...
            tabPanel("About",HTML("<h1> Ahmad Nazzal </h1>
        <p>
        ...
        <p>
        <a href="https://github.com/anazzal21/STAT-5702-Project" target="_blank">Github</a>
        </p>
        ')#End of html part 2), #This is the new tab with some info
